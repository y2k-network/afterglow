# Relay Client Requirements for @y2k-network/afterglow Servers
...
@y2k-network/afterglow already covers the structural core that relay-compiler will not
...
The canonical set (current as of relay 19+) that @y2k-network/afterglow should
