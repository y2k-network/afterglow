# @y2k-network/afterglow v2 Design: Effect-Native API

> Status: Implemented — this Layer-driven design (Pattern C) is the
> current public API. Transport-related sections describe work that
> lives on the `feat/afterglow` branch.
...
const main = async () => {
  ...
  console.log(`@y2k-network/afterglow v2 example listening on ${server.url}`)
