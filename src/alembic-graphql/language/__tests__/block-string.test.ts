...
describe('isPrintableAsBlockString', () => {
  function expectPrintable(str: string) {
    return expect(isPrintableAsBlockString(str)).toBe(true);
  }

  function expectNonPrintable(str: string) {
    return expect(isPrintableAsBlockString(str)).toBe(false);
  }
  ...
  function expectBlockString(str: string) {
    return {
      toEqual(expected: string | { readable: string; minimize: string }) {
        ...
        expect(printBlockString(str)).toBe(readable);
        expect(printBlockString(str, { minimize: true })).toBe(minimize);
      },
    };
  }
