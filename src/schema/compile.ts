/**
 * V2 IR -> Alembic GraphQL lowering. Reuses v1's relay primitives (Node interface,
...
} from "../alembic-graphql/type/directives.ts";
...
export function lower(ir: IR, options: LowerOptions = {}): GraphQLSchema {
  ...
  // Alembic GraphQL types are constructed. Errors aggregate and throw; warnings
