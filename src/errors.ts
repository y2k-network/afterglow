/**
 * Tagged error vocabulary for @athanor/alembic. Every internal failure mode
...
import type { GraphQLError } from "./alembic-graphql/error/graph-ql-error.ts";
