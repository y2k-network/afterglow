 ...
 * graphql-js's validator accepts operations that use them.
 */
import {
  DirectiveLocation,
  GraphQLBoolean,
...
import { matchDirective, moduleDirective } from "./relay-3d.ts";
...
// ──────────────────────────────────────────────────────────────────────────
// Incremental delivery — declarations only. Runtime support lives behind a
// future task (T21). Argument shapes follow `DeferStreamInterface::default()`
// in `relay-config`.
...
// ──────────────────────────────────────────────────────────────────────────
// Re-exports of T11's @match / @module so this module is the comprehensive
