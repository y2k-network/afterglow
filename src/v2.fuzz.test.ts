...
import { buildSchemaSync as gqlBuildSchema } from "./afterglow-graphql/utilities/build-ast-schema.ts";
...
import type { GraphQLNamedType } from "./afterglow-graphql/type/definition.ts";
import {
  Connection,
  Node,
  Query,
