...
import { toError } from "../jsutils/to-error.ts";

import type { ASTNode } from "../language/ast.ts";

import { type GraphQLError, GraphQLLocatedError } from './graph-ql-error.ts';
...
export function locatedError(
  ...
  return new GraphQLLocatedError(originalError.message, {
